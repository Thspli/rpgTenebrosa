...
export const CLASSES: Record<ClassType, ClassDefinition> = {
  warrior: {
    name: 'Guerreiro', emoji: '⚔️', color: '#e74c3c', role: 'tank',
  ...
  mage: {
    name: 'Mago', emoji: '🔮', color: '#9b59b6', role: 'dps',
  ...
  rogue: {
    name: 'Ladino', emoji: '🗡️', color: '#1abc9c', role: 'dps',
  ...
  necromancer: {
    name: 'Necromante', emoji: '💀', color: '#8e44ad', role: 'hybrid',
  ...
  paladin: {
    name: 'Paladino', emoji: '🛡️', color: '#f39c12', role: 'support',
  ...
  ranger: {
    name: 'Arqueiro', emoji: '🏹', color: '#3498db', role: 'dps',
  ...
  assassin: {
    name: 'Assassino', emoji: '🌙', color: '#2c3e50', role: 'dps',
  ...
  elementalist: {
    name: 'Elementalista', emoji: '🌊', color: '#e67e22', role: 'dps',
  ...
  berserker: {
    name: 'Berserker', emoji: '🪓', color: '#c0392b', role: 'dps',
  ...
  guardian: {
    name: 'Guardião', emoji: '🗿', color: '#7f8c8d', role: 'tank',
  ...
  druid: {
    name: 'Druida', emoji: '🌿', color: '#27ae60', role: 'support',
  ...
  bard: {
    name: 'Bardo', emoji: '🎵', color: '#d35400', role: 'support',
  ...
  animalist: {
    name: 'Animalista', emoji: '🐾', color: '#a0522d', role: 'hybrid',
  ...
  shaman: {
    name: 'Xamã', emoji: '🌀', color: '#5f9ea0', role: 'hybrid',
  ...
  trickster: {
    name: 'Ilusionista', emoji: '🃏', color: '#da70d6', role: 'hybrid',
