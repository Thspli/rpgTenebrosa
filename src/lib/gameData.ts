...
export const SKILLS: Record<ClassType, Skill[]> = {
  ...
  { name: 'Invocar Lobo',      emoji: '🐺', mpCost: 20, effect: 'summon_animal', summonAnimalId: 'wolf_summon',
    description: 'Lobo da Matilha [ATK duplo, 4 turnos]' },
  { name: 'Invocar Urso',      emoji: '🐻', mpCost: 25, effect: 'summon_animal', summonAnimalId: 'bear_summon',
    description: 'Urso Guardião [Provoca inimigos, tanque, 4 turnos]' },
  { name: 'Invocar Cervo',     emoji: '🦌', mpCost: 28, effect: 'summon_animal', summonAnimalId: 'stag_summon',
    description: 'Cervo Sagrado [Cura aliado com menos HP por turno]' },
  { name: 'Invocar Javali',    emoji: '🐗', mpCost: 30, effect: 'summon_animal', summonAnimalId: 'boar_summon',
    description: 'Javali de Guerra [Buffa +4 ATK em todos por turno]' },
  { name: 'Invocar Fera',      emoji: '🐆', mpCost: 40, effect: 'summon_animal', summonAnimalId: 'beast_summon',
  ...
  { name: 'TEMPESTADE ANIMAL', emoji: '🌿', mpCost: 100, damage: 30, aoe: true, effect: 'ult', ultLevel: 3,
    ...
    description: '🐾 ULT: +30 dano em TODOS + invoca 3 aliados automaticamente. (Nv.3)' },
],
  shaman: [
  ...
  { name: 'Clone Ilusório',     emoji: '👤', mpCost: 30, effect: 'clone', cloneTurns: 3,
    description: 'Clone absorve 1 golpe e reflete 80% por 3 turnos' },
  { name: 'Troca de Lugar',     emoji: '🔄', mpCost: 20, effect: 'position_swap', targetAlly: true,
    description: 'Troca de lugar com aliado: Ilusionista absorve 30% do dano dele por 2 turnos' },
  { name: 'Ilusão de Força',    emoji: '💪', mpCost: 25, effect: 'illusion_atk', targetAlly: true,
    description: 'Aliado ganha +8 ATK e 2 esquivas por 2 turnos' },
  { name: 'Duplo Falso',        emoji: '👥', mpCost: 35, damage: 20, effect: 'mark', markMult: 2.0, markTurns: 3,
