...
export const CLASSES: Record<ClassType, ClassDefinition> = {
  ...
  animalist: {
    name: 'Animalista', emoji: '🐾',
    description: 'Mestre dos animais. Invoca até 3 companheiros selvagens que agem na iniciativa.',
    baseStats: { hp: 110, mp: 110, attack: 10, defense: 6 },
    special: 'Chamado Selvagem: Invoca lobos, ursos, águias e feras.',
    unlockedByDefault: true, color: '#a0522d',
  },
  shaman: {
    name: 'Xamã', emoji: '🌀',
    description: 'Canaliza espíritos ancestrais. Acumula até 5 cargas e as libera em explosão.',
    baseStats: { hp: 95, mp: 140, attack: 11, defense: 4 },
    special: 'Cargas Espirituais: Acumula com Golpe Espiritual, libera com Liberar Espíritos.',
    unlockedByDefault: true, color: '#5f9ea0',
  },
  trickster: {
    name: 'Ilusionista', emoji: '🃏',
    description: 'Mestre do engano. Cria clones que absorvem golpes e contra-atacam.',
    baseStats: { hp: 90, mp: 130, attack: 13, defense: 3 },
    special: 'Clone Ilusório: Absorve 1 golpe e reflete 80% do dano por 3 turnos.',
    unlockedByDefault: true, color: '#da70d6',
  },
};
...
export const SKILLS: Record<ClassType, Skill[]> = {
  ...
  rogue: [
   ...
   necromancer: [
    ...
    { name: 'Drenar Vida',        emoji: '🩸', mpCost: 20, damage: 12, heal: 18, selfOnly: true, description: '+12 dano, drena 18HP de volta' },
    ...
    { name: 'Invocar Sombra',     emoji: '👻', mpCost: 40, effect: 'summon_shadow', description: 'Gasta 1 Alma: invoca a sombra do último inimigo morto por 4 turnos' },
  ...
  animalist: [
    { name: 'Mordida Selvagem',   emoji: '🦷', mpCost: 0,  damage: 5,  description: '+5 dano de mordida' },
    { name: 'Invocar Lobo',       emoji: '🐺', mpCost: 25, effect: 'summon_animal', summonAnimalId: 'wolf_summon',   description: 'Invoca Lobo [HP60 ATK+30% dura 3t]' },
    { name: 'Invocar Urso',       emoji: '🐻', mpCost: 35, effect: 'summon_animal', summonAnimalId: 'bear_summon',   description: 'Invoca Urso [HP100 ATK12 provoca inimigos dura 3t]' },
    { name: 'Rugido da Matilha',  emoji: '🦁', mpCost: 20, effect: 'group_atk_up', atkGroupBonus: 4, atkGroupTurns: 3, description: '+4 ATK para TODOS por 3 turnos' },
    { name: 'Invocar Águia',      emoji: '🦅', mpCost: 30, effect: 'summon_animal', summonAnimalId: 'eagle_summon',  description: 'Invoca Águia [HP45 ataca 2× dura 3t]' },
    { name: 'Fera Selvagem',      emoji: '🐆', mpCost: 50, effect: 'summon_animal', summonAnimalId: 'beast_summon',  description: 'Invoca Fera Selvagem [HP80 ATK16 ignora 80% DEF dura 3t]' },
    { name: 'TEMPESTADE ANIMAL',  emoji: '🌿', mpCost: 100, damage: 30, aoe: true, effect: 'ult', ultLevel: 3,
      ...
      description: '🐾 ULT: Enxurrada de criaturas ataca TODOS. (Nv.3)' },
  ],
  shaman: [
    { name: 'Golpe Espiritual',        emoji: '🌀', mpCost: 5,  damage: 6,  effect: 'spirit_stack', description: '+6 dano + ganha 1 Carga Espiritual [máx 5]' },
    { name: 'Cura Ancestral',          emoji: '🌿', mpCost: 20, heal: 35,   targetAlly: true, description: 'Cura 35HP em aliado' },
    { name: 'Maldição dos Espíritos',  emoji: '👁️', mpCost: 25, effect: 'curse', curseDef: 6, curseAtk: 5, curseTurns: 4, description: '-6 DEF e -5 ATK no alvo' },
    { name: 'Liberar Espíritos',       emoji: '💫', mpCost: 20, damage: 0,   effect: 'spirit_stack', description: 'Libera cargas: 15 dano × cargas em TODOS os inimigos' },
    { name: 'Totem de Cura',           emoji: '🏺', mpCost: 30, effect: 'regen', regenHp: 12, regenTurns: 4, targetAlly: true, description: '+12 HP/turno por 4 turnos em aliado' },
    { name: 'Raiva Ancestral',         emoji: '⚡', mpCost: 40, damage: 20, aoe: true, description: '+20 dano espiritual em TODOS' },
    { name: 'CONVERGÊNCIA ESPIRITUAL', emoji: '🌌', mpCost: 100, damage: 45, aoe: true, heal: 35, effect: 'ult', ultLevel: 3,
  ...
  trickster: [
    { name: 'Faca Ilusória',       emoji: '🃏', mpCost: 0,  damage: 7,  description: '+7 dano ilusório' },
    { name: 'Cortina de Fumaça',   emoji: '💨', mpCost: 15, effect: 'dodge', description: 'Esquiva dos próximos 2 ataques' },
    { name: 'Clone Ilusório',      emoji: '👤', mpCost: 30, effect: 'clone', cloneTurns: 3, description: 'Clone absorve 1 golpe e reflete 80% por 3 turnos' },
    { name: 'Golpe Triplo Falso',  emoji: '⚡', mpCost: 25, damage: 14, description: '+14 dano ignora 30% DEF' },
    { name: 'Confusão Mental',     emoji: '🌀', mpCost: 30, effect: 'stun', stunTurns: 2, description: 'Confunde o alvo: perde 2 turnos' },
    { name: 'Marca do Ilusionista',emoji: '🎯', mpCost: 25, effect: 'mark', markMult: 1.8, markTurns: 3, description: '+80% dano no alvo por 3 turnos' },
    { name: 'ILUSÃO TOTAL',        emoji: '🌈', mpCost: 100, damage: 55, aoe: true, effect: 'ult', ultLevel: 3,
      ...
      description: '🃏 ULT: Cópias infinitas atacam todos os inimigos. (Nv.3)' },
  ],
};
